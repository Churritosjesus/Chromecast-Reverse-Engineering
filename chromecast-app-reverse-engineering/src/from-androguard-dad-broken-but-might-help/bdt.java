	 java.util.ArrayList a
	    ...
	    public final int a()
	    {
	        int v0_0 = -1;
	        try {
	            org.json.JSONArray v3_1 = this.a("supported_timezones", bdt.c);
	        } catch (int v0) {
	            v0_0 = -2;
	            return v0_0;
	            ...
	            if ((v0_1 != 0) && ("application/json".equals(v0_1.b))) {
	                ...
	                if (v0_2 != 0) {
	                    ...
	                    while (v0_3 < v5_1) {
	                        ...
	                        v4_4.add(new bdb(v6_0.getString("timezone"), v6_0.getString("display_string"), v6_0.getInt("offset")));
	                        v0_3++;
	                    }
	                    this.a = v4_4;
	                    v0_0 = 0;
