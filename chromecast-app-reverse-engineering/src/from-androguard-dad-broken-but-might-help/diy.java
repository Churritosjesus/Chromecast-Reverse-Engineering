	static final B a
	    ...
	    public final dib a(dkd p2, boolean p3)
	    {
	        return new diz(p2, p3);
	    }
	
	
	    public final did a(dkc p2, boolean p3)
	    {
	        return new dja(p2, p3);
	    }
