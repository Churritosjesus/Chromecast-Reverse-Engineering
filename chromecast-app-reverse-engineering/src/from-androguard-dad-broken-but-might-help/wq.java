	...
	private android.graphics.drawable.Drawable c
	    ...
	    public wq(android.content.Context p2, android.util.AttributeSet p3)
	    {
	        this(p2, p3, a.M);
	        return;
	    }
	    ...
	    private wq(android.content.Context p4, android.util.AttributeSet p5, int p6)
	    {
	        this(p4, p5, p6);
	        if (tf.a) {
	            tf v0_2 = th.a(this.getContext(), p5, wq.a, p6, 0);
