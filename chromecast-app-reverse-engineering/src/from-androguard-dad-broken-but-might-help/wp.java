	...
	private tf c
	    ...
	    public wp(android.content.Context p2, android.util.AttributeSet p3)
	    {
	        this(p2, p3, a.w);
	        return;
	    }
	    ...
	    private wp(android.content.Context p6, android.util.AttributeSet p7, int p8)
	    {
	        this(tc.a(p6), p7, p8);
	        if (tf.a) {
	            android.content.res.TypedArray v0_3 = th.a(this.getContext(), p7, wp.a, p8, 0);
	            this.c = v0_3.a();
	            if (v0_3.d(0)) {
