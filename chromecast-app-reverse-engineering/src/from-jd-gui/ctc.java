  ...
  implements cta
{
  ...
  public final void a(ConnectionResult paramConnectionResult, AuthAccountResult paramAuthAccountResult)
  {
    ...
    for (;;)
    {
      try
      {
        localParcel2.writeInterfaceToken("com.google.android.gms.signin.internal.ISignInCallbacks");
        if (paramConnectionResult != null)
        {
          localParcel2.writeInt(1);
          paramConnectionResult.writeToParcel(localParcel2, 0);
          if (paramAuthAccountResult != null)
          {
            localParcel2.writeInt(1);
            paramAuthAccountResult.writeToParcel(localParcel2, 0);
  ...
  public final void a(com.google.android.gms.common.api.Status paramStatus)
  {
    ...
    //   29: aload_0
    //   30: getfield 15	ctc:a	Landroid/os/IBinder;
    //   33: iconst_4
    //   34: aload_2
    //   35: aload_3
    //   36: iconst_0
...
/* Location:              C:\DEV\android\dex2jar-2.1-SNAPSHOT\classes-dex2jar.jar!\ctc.class
