...
.method static varargs a(Landroid/content/pm/PackageInfo;[Lcah;)Lcah;
    .locals 5
    ...
    invoke-direct {v3, v0}, Lcdi;-><init>([B)V
    ...
    invoke-virtual {v4, v3}, Lcah;->equals(Ljava/lang/Object;)Z
...
.method private static a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {}, Lcag;->a()Ljava/util/Set;
    ...
    :cond_1
    invoke-static {}, Lcag;->b()Ljava/util/Set;
...
.method public final a(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
    ...
    .line 1000
    :cond_1
    invoke-static {p1}, Lbvt;->a(Landroid/content/pm/PackageManager;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {v1, v3}, Lbvu;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    :cond_2
    invoke-static {v1, v0}, Lbvu;->a(Landroid/content/pm/PackageInfo;Z)Z
