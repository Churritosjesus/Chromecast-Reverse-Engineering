...
.field private synthetic c:Lbqn;
...
.method public constructor <init>(Lbqn;)V
    ...
    iput-object v0, p0, Lbqo;->b:Ljava/io/ByteArrayOutputStream;
...
.method public final a(Lbsi;)Z
    ...
    :cond_0
    iget-object v0, p0, Lbqo;->c:Lbqn;

    invoke-virtual {v0, p1, v1}, Lbqn;->a(Lbsi;Z)Ljava/lang/String;
    ...
    :cond_2
    iget-object v4, p0, Lbqo;->b:Ljava/io/ByteArrayOutputStream;
    ...
    :cond_4
    :try_start_0
    iget-object v0, p0, Lbqo;->b:Ljava/io/ByteArrayOutputStream;
    ...
    iget-object v1, p0, Lbqo;->c:Lbqn;

    const-string v3, "Failed to write payload when batching hits"

    invoke-virtual {v1, v3, v0}, Lbqn;->e(Ljava/lang/String;Ljava/lang/Object;)V
