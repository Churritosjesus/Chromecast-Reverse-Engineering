...
# direct methods
.method constructor <init>(Lorg/apache/http/client/HttpClient;Landroid/content/Context;Lcxx;)V
    .locals 9
    ...
    iput-object v1, p0, Lcxw;->c:Landroid/content/Context;
    ...
    .line 0
    iput-object v0, p0, Lcxw;->a:Ljava/lang/String;

    iput-object p1, p0, Lcxw;->b:Lorg/apache/http/client/HttpClient;

    iput-object p3, p0, Lcxw;->d:Lcxx;
...
.method private static a(Lcvk;)Ljava/net/URL;
    .locals 2

    .prologue
    .line 0
    .line 3000
    iget-object v1, p0, Lcvk;->c:Ljava/lang/String;
...
.method private a(Ljava/net/URL;)Lorg/apache/http/HttpEntityEnclosingRequest;
    ...
    iget-object v2, p0, Lcxw;->a:Ljava/lang/String;
...
.method public final a(Ljava/util/List;)V
    ...
    invoke-static {v0}, Lcxw;->a(Lcvk;)Ljava/net/URL;
    ...
    iget-object v2, p0, Lcxw;->d:Lcxx;

    invoke-interface {v2, v0}, Lcxx;->b(Lcvk;)V
    ...
    :cond_0
    invoke-direct {p0, v2}, Lcxw;->a(Ljava/net/URL;)Lorg/apache/http/HttpEntityEnclosingRequest;
    ...
    invoke-static {v6}, Lcxw;->a(Lorg/apache/http/HttpEntityEnclosingRequest;)V

    if-eqz v1, :cond_2

    :try_start_0
    iget-object v2, p0, Lcxw;->c:Landroid/content/Context;

    invoke-static {v2}, Lcwg;->a(Landroid/content/Context;)V

    move v1, v3

    :cond_2
    iget-object v2, p0, Lcxw;->b:Lorg/apache/http/client/HttpClient;
    ...
    invoke-interface {v2, v0}, Lcxx;->c(Lcvk;)V
    ...
    invoke-interface {v2, v0}, Lcxx;->a(Lcvk;)V
    :try_end_0
    ...
    invoke-static {v6}, Lcuh;->b(Ljava/lang/String;)V
...
.method public final a()Z
    ...
    iget-object v0, p0, Lcxw;->c:Landroid/content/Context;
