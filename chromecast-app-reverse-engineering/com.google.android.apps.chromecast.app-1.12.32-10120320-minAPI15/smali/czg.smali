...
.field private d:Lczk;

.field private e:Lcac;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lczg;->a:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {v0 .. v5}, Lczg;-><init>(Landroid/content/Context;Lcac;Ljava/lang/String;ILjava/util/concurrent/Executor;)V

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Lcac;Ljava/lang/String;ILjava/util/concurrent/Executor;)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lczg;->c:Landroid/content/Context;

    iput-object p2, p0, Lczg;->e:Lcac;

    const/16 v0, 0x7d0

    iput v0, p0, Lczg;->f:I

    iput-object p5, p0, Lczg;->b:Ljava/util/concurrent/Executor;

    new-instance v0, Lczk;

    iget-object v1, p0, Lczg;->c:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p3}, Lczk;-><init>(Lczg;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lczg;->d:Lczk;
...
.method static synthetic a()Ljava/lang/String;
    ...
    sget-object v0, Lczg;->a:Ljava/lang/String;
...
.method private a(I)Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lczg;->b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method static synthetic a(Lczg;)Ljava/util/List;
    .locals 1

    invoke-direct {p0}, Lczg;->b()Ljava/util/List;
...
.method static synthetic a(Lczg;Ljava/lang/String;)V
    .locals 7
...
.method static synthetic a(Lczg;Ljava/util/List;J)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lczg;->b(Ljava/util/List;J)V
...
.method static synthetic b(Lczg;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lczg;->c:Landroid/content/Context;
...
.method private b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_0
    iget-object v0, p0, Lczg;->d:Lczk;

    invoke-virtual {v0}, Lczk;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private b()Ljava/util/List;
    ...
    .line 0
    :try_start_0
    iget-object v0, p0, Lczg;->e:Lcac;

    invoke-interface {v0}, Lcac;->a()J

    move-result-wide v0

    invoke-direct {p0, v0, v1}, Lczg;->a(J)V

    invoke-direct {p0}, Lczg;->c()Ljava/util/List;
    ...
    iget-object v4, v0, Lczl;->a:Ljava/lang/String;

    iget-object v0, v0, Lczl;->b:[B

    invoke-static {v0}, Lczg;->a([B)Ljava/lang/Object;

    move-result-object v0

    invoke-direct {v3, v4, v0}, Lctz;-><init>(Ljava/lang/String;Ljava/lang/Object;)V
...
.method private declared-synchronized b(Ljava/util/List;J)V
    ...
    invoke-direct {p0, v2, v3}, Lczg;->a(J)V
    ...
    invoke-direct {p0, v0}, Lczg;->a(I)Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lczg;->a([Ljava/lang/String;)V

    .line 0
    :cond_0
    add-long v0, v2, p2

    invoke-direct {p0, p1, v0, v1}, Lczg;->c(Ljava/util/List;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private c()Ljava/util/List;
    ...
    invoke-direct {v0, v2, v3}, Lczl;-><init>(Ljava/lang/String;[B)V
...
.method private c(Ljava/util/List;J)V
    ...
    iget-object v5, v0, Lczl;->a:Ljava/lang/String;
...
.method private d()I
    ...
    invoke-direct {p0, v2}, Lczg;->b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
# virtual methods
.method public final a(Lcuc;)V
    .locals 2

    iget-object v0, p0, Lczg;->b:Ljava/util/concurrent/Executor;

    new-instance v1, Lczi;

    invoke-direct {v1, p0, p1}, Lczi;-><init>(Lczg;Lcuc;)V
...
.method public final a(Ljava/lang/String;)V
    ...
    invoke-direct {v1, p0, p1}, Lczj;-><init>(Lczg;Ljava/lang/String;)V
...
.method public final a(Ljava/util/List;J)V
    ...
    iget-object v4, v0, Lctz;->a:Ljava/lang/String;

    iget-object v0, v0, Lctz;->b:Ljava/lang/Object;

    invoke-static {v0}, Lczg;->a(Ljava/lang/Object;)[B

    move-result-object v0

    invoke-direct {v3, v4, v0}, Lczl;-><init>(Ljava/lang/String;[B)V
    ...
    invoke-direct {v2, p0, v1, p2, p3}, Lczh;-><init>(Lczg;Ljava/util/List;J)V
