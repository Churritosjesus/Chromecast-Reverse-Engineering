...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 72
    invoke-direct {p0, p1, p2, p3}, Lwt;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public static synthetic a(Landroid/support/v7/internal/view/menu/ActionMenuItemView;)Lpu;
    .locals 1

    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->b:Lpu;

    return-object v0
.end method

.method public static synthetic b(Landroid/support/v7/internal/view/menu/ActionMenuItemView;)Lqc;
    .locals 1

    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->a:Lqc;

    return-object v0
.end method

.method public static synthetic c(Landroid/support/v7/internal/view/menu/ActionMenuItemView;)Lqe;
    .locals 1

    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->c:Lqe;
...
.method private f()V
    ...
    iget-object v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->c:Lqe;
...
.method public final a(Lqe;I)V
    ...
    .line 112
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->c:Lqe;

    .line 114
    invoke-virtual {p1}, Lqe;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 115
    invoke-virtual {p1, p0}, Lqe;->a(Lqs;)Ljava/lang/CharSequence;
    ...
    .line 116
    invoke-virtual {p1}, Lqe;->getItemId()I
    ...
    .line 118
    invoke-virtual {p1}, Lqe;->isVisible()Z
    ...
    .line 121
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->f:Lyg;
    ...
    invoke-direct {v0, p0}, Lpt;-><init>(Landroid/support/v7/internal/view/menu/ActionMenuItemView;)V

    iput-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->f:Lyg;
...
.method public final d()Z
    ...
    invoke-virtual {v0}, Lqe;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->c:Lqe;

    invoke-interface {v0, v1}, Lqc;->a(Lqe;)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 93
    invoke-super {p0, p1}, Lwt;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    .line 246
    invoke-static {p1}, Lgt;->g(Landroid/view/View;)I
    ...
    .line 250
    :cond_1
    iget-object v5, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->c:Lqe;

    invoke-virtual {v5}, Lqe;->getTitle()Ljava/lang/CharSequence;
...
.method protected onMeasure(II)V
    ...
    invoke-super {p0, v0, v2, v3, v4}, Lwt;->setPadding(IIII)V

    .line 270
    :cond_0
    invoke-super {p0, p1, p2}, Lwt;->onMeasure(II)V
    ...
    invoke-super {p0, v0, p2}, Lwt;->onMeasure(II)V
    ...
    invoke-super {p0, v0, v1, v2, v3}, Lwt;->setPadding(IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    invoke-super {p0, p1}, Lwt;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public setPadding(IIII)V
    ...
    .line 104
    invoke-super {p0, p1, p2, p3, p4}, Lwt;->setPadding(IIII)V
