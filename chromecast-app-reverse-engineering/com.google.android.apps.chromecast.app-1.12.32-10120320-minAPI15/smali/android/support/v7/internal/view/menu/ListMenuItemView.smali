...
.method public final a()Lqe;
    ...
    .prologue
    .line 126
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->c:Lqe;
...
.method public final a(Lqe;I)V
    ...
    .line 99
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->c:Lqe;
    ...
    :cond_0
    :goto_1
    invoke-virtual {p1}, Lqe;->isCheckable()Z
    ...
    invoke-virtual {v0}, Lqe;->isChecked()Z
    ...
    :cond_4
    :goto_4
    invoke-virtual {p1}, Lqe;->d()Z

    move-result v0

    invoke-virtual {p1}, Lqe;->c()C
