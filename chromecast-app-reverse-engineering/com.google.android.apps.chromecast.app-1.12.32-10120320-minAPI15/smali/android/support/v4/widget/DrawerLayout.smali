...
.field private final p:Lkx;

.field private final q:Lkx;
...
.method static constructor <clinit>()V
    ...
    sput-object v2, Landroid/support/v4/widget/DrawerLayout;->j:[I
    ...
    :goto_0
    sput-boolean v0, Landroid/support/v4/widget/DrawerLayout;->k:Z
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->z:Lkq;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Lkp;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lkp;

    .line 171
    const/high16 v0, -0x67000000

    iput v0, p0, Landroid/support/v4/widget/DrawerLayout;->a:I
    ...
    invoke-direct {v1, p0, v2}, Lkx;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->p:Lkx;
    ...
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->q:Lkx;

    .line 342
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->p:Lkx;

    invoke-static {p0, v4, v1}, Lmf;->a(Landroid/view/ViewGroup;FLmi;)Lmf;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lmf;

    .line 343
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lmf;
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lmf;

    .line 3639
    iput-object v2, v1, Lkx;->b:Lmf;

    .line 347
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->q:Lkx;

    invoke-static {p0, v4, v1}, Lmf;->a(Landroid/view/ViewGroup;FLmi;)Lmf;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->c:Lmf;

    .line 348
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->c:Lmf;
    ...
    .line 350
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->q:Lkx;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->c:Lmf;

    .line 5639
    iput-object v1, v0, Lkx;->b:Lmf;

    .line 353
    invoke-virtual {p0, v3}, Landroid/support/v4/widget/DrawerLayout;->setFocusableInTouchMode(Z)V

    .line 355
    invoke-static {p0, v3}, Lgt;->c(Landroid/view/View;I)V

    .line 358
    new-instance v0, Lko;

    invoke-direct {v0, p0}, Lko;-><init>(Landroid/support/v4/widget/DrawerLayout;)V
    ...
    invoke-static {p0, v0}, Lhk;->a(Landroid/view/ViewGroup;Z)V

    .line 360
    invoke-static {p0}, Lgt;->r(Landroid/view/View;)Z
    ...
    .line 361
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->z:Lkq;

    invoke-interface {v0, p0}, Lkq;->a(Landroid/view/View;)V

    .line 362
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->z:Lkq;

    invoke-interface {v0, p1}, Lkq;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method private a(II)V
    ...
    invoke-static {p2, v0}, Lfe;->a(II)I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lmf;
    ...
    .line 482
    :cond_4
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->c:Lmf;
...
.method private a(Z)V
    ...
    .line 1268
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lmf;
    ...
    invoke-virtual {v7, v5, v6, v8}, Lmf;->a(Landroid/view/View;II)Z
    ...
    .line 1271
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->c:Lmf;
    ...
    invoke-virtual {v6, v5, v7, v8}, Lmf;->a(Landroid/view/View;II)Z
    ...
    .line 1278
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->p:Lkx;
...
.method public static synthetic a()[I
    ...
    .prologue
    .line 86
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->j:[I
...
.method public static d(Landroid/view/View;)Z
    ...
    invoke-static {v0, v1}, Lfe;->a(II)I
...
.method public final a(Landroid/view/View;F)V
    ...
    .line 5700
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->f:Lkt;
    ...
    invoke-interface {v0, p2}, Lkt;->a(F)V
...
.method public a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Lgt;->c(Landroid/view/View;I)V
...
.method public final a(Ljava/lang/Object;Z)V
    ...
    .prologue
    .line 372
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->x:Ljava/lang/Object;

    .line 373
    iput-boolean p2, p0, Landroid/support/v4/widget/DrawerLayout;->y:Z
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Lgt;->c(Landroid/view/View;I)V
    ...
    .line 1571
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lkp;

    invoke-static {p1, v0}, Lgt;->a(Landroid/view/View;Ler;)V
...
.method public final b(I)Landroid/view/View;
    ...
    invoke-static {p1, v0}, Lfe;->a(II)I
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Lmf;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->c:Lmf;

    invoke-virtual {v1, v4}, Lmf;->a(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 1093
    iget v2, p0, Landroid/support/v4/widget/DrawerLayout;->a:I
    ...
    iget v3, p0, Landroid/support/v4/widget/DrawerLayout;->a:I
    ...
    .line 1113
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->c:Lmf;
...
.method public final e(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Lmf;->a(Landroid/view/View;II)Z
...
.method protected generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, v1}, Lku;-><init>(II)V
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Lku;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Lku;-><init>(Lku;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1053
    iget-boolean v0, p0, Landroid/support/v4/widget/DrawerLayout;->y:Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->x:Ljava/lang/Object;

    invoke-interface {v0, v1}, Lkq;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1140
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lmf;

    invoke-virtual {v3, p1}, Lmf;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->c:Lmf;

    invoke-virtual {v4, p1}, Lmf;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 1152
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lmf;

    float-to-int v0, v0

    float-to-int v3, v3

    invoke-virtual {v5, v0, v3}, Lmf;->a(II)Landroid/view/View;
    ...
    .line 1158
    :goto_4
    iput-boolean v2, p0, Landroid/support/v4/widget/DrawerLayout;->e:Z
    ...
    .line 8341
    iget-object v0, v5, Lmf;->f:[F

    aget v0, v0, v3

    iget-object v7, v5, Lmf;->d:[F
    ...
    .line 8342
    iget-object v7, v5, Lmf;->g:[F

    aget v7, v7, v3

    iget-object v8, v5, Lmf;->e:[F
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 1501
    invoke-static {p2}, Lfi;->b(Landroid/view/KeyEvent;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget v2, v0, Lku;->topMargin:I

    iget v3, v0, Lku;->leftMargin:I
    ...
    .line 931
    iget v4, v0, Lku;->topMargin:I

    add-int/2addr v9, v2

    iget v11, v0, Lku;->topMargin:I
    ...
    .line 938
    iget v10, v0, Lku;->bottomMargin:I
    ...
    iget v11, v0, Lku;->bottomMargin:I
    ...
    iget v13, v0, Lku;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    .line 838
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->x:Ljava/lang/Object;
    ...
    invoke-static {v8, v5}, Lfe;->a(II)I

    move-result v8

    .line 855
    invoke-static {v7}, Lgt;->r(Landroid/view/View;)Z
    ...
    .line 856
    sget-object v9, Landroid/support/v4/widget/DrawerLayout;->z:Lkq;

    iget-object v10, p0, Landroid/support/v4/widget/DrawerLayout;->x:Ljava/lang/Object;

    invoke-interface {v9, v7, v10, v8}, Lkq;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    .line 864
    iget v8, v0, Lku;->leftMargin:I

    sub-int v8, v2, v8

    iget v9, v0, Lku;->rightMargin:I
    ...
    .line 866
    iget v9, v0, Lku;->topMargin:I

    sub-int v9, v1, v9

    iget v0, v0, Lku;->bottomMargin:I
    ...
    invoke-interface {v9, v0, v10, v8}, Lkq;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    invoke-static {v8}, Landroid/support/v4/widget/DrawerLayout;->c(I)Ljava/lang/String;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1522
    invoke-virtual {p1}, Lkv;->getSuperState()Landroid/os/Parcelable;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Lkv;-><init>(Landroid/os/Parcelable;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v2, p1}, Lmf;->b(Landroid/view/MotionEvent;)V

    .line 1185
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->c:Lmf;
    ...
    .line 1194
    iput v2, p0, Landroid/support/v4/widget/DrawerLayout;->v:F
    ...
    .line 1205
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lmf;

    float-to-int v5, v2

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Lmf;->a(II)Landroid/view/View;
