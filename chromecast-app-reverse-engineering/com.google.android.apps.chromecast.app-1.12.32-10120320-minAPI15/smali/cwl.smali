...
.field private volatile c:Lcuz;

.field private final d:Lcvp;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcwl;->a:Ljava/lang/String;

    return-void
.end method

.method constructor <init>(Lcvp;Landroid/content/Context;)V
    .locals 2
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lcwl;-><init>(Lcvp;Landroid/content/Context;Ljava/lang/String;I)V

    return-void
.end method

.method private constructor <init>(Lcvp;Landroid/content/Context;Ljava/lang/String;I)V
    .locals 4
    ...
    iput-object v0, p0, Lcwl;->e:Landroid/content/Context;

    iput-object p3, p0, Lcwl;->f:Ljava/lang/String;

    iput-object p1, p0, Lcwl;->d:Lcvp;

    invoke-static {}, Lcad;->c()Lcac;

    move-result-object v0

    iput-object v0, p0, Lcwl;->h:Lcac;

    new-instance v0, Lcwn;

    iget-object v1, p0, Lcwl;->e:Landroid/content/Context;

    iget-object v2, p0, Lcwl;->f:Ljava/lang/String;

    invoke-direct {v0, p0, v1, v2}, Lcwn;-><init>(Lcwl;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lcwl;->b:Lcwn;
    ...
    iget-object v2, p0, Lcwl;->e:Landroid/content/Context;

    new-instance v3, Lcwm;

    invoke-direct {v3, p0}, Lcwm;-><init>(Lcwl;)V

    invoke-direct {v0, v1, v2, v3}, Lcxw;-><init>(Lorg/apache/http/client/HttpClient;Landroid/content/Context;Lcxx;)V

    iput-object v0, p0, Lcwl;->c:Lcuz;
...
.method private a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_0
    iget-object v0, p0, Lcwl;->b:Lcwn;

    invoke-virtual {v0}, Lcwn;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
...
.method static synthetic a(Lcwl;)Lcac;
    .locals 1

    iget-object v0, p0, Lcwl;->h:Lcac;
...
.method private a(I)Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lcwl;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method private a(J)V
    ...
    invoke-direct {p0, v0}, Lcwl;->a([Ljava/lang/String;)V

    return-void
.end method

.method static synthetic a(Lcwl;J)V
    .locals 1

    invoke-direct {p0, p1, p2}, Lcwl;->a(J)V

    return-void
.end method

.method static synthetic a(Lcwl;JJ)V
    .locals 7
...
.method private a([Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, Lcwl;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v2, p0, Lcwl;->d:Lcvp;

    invoke-direct {p0}, Lcwl;->c()I
    ...
    :goto_1
    invoke-interface {v2, v0}, Lcvp;->a(Z)V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method static synthetic b(Lcwl;)Ljava/lang/String;
    .locals 1

    iget-object v0, p0, Lcwl;->f:Ljava/lang/String;
...
.method private b(I)Ljava/util/List;
    ...
    invoke-direct {v0, v2}, Lcwl;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct/range {v3 .. v9}, Lcvk;-><init>(JJJ)V
    ...
    :cond_9
    :try_start_6
    iput-object v5, v2, Lcvk;->c:Ljava/lang/String;
    :try_end_6
    ...
    .line 6000
    iget-object v6, v2, Lcvk;->c:Ljava/lang/String;
...
.method static synthetic c(Lcwl;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lcwl;->e:Landroid/content/Context;
...
.method public final a()V
    ...
    iget-object v0, p0, Lcwl;->c:Lcuz;

    invoke-interface {v0}, Lcuz;->a()Z
    ...
    invoke-direct {p0, v0}, Lcwl;->b(I)Ljava/util/List;
    ...
    iget-object v0, p0, Lcwl;->d:Lcvp;

    const/4 v1, 0x1

    invoke-interface {v0, v1}, Lcvp;->a(Z)V

    goto :goto_0

    :cond_2
    iget-object v1, p0, Lcwl;->c:Lcuz;

    invoke-interface {v1, v0}, Lcuz;->a(Ljava/util/List;)V

    invoke-direct {p0}, Lcwl;->d()I
...
.method public final a(JLjava/lang/String;)V
    ...
    .line 0
    .line 1000
    iget-object v2, p0, Lcwl;->h:Lcac;

    invoke-interface {v2}, Lcac;->a()J

    move-result-wide v2

    iget-wide v4, p0, Lcwl;->g:J
    ...
    invoke-direct {p0, v0}, Lcwl;->a(I)Ljava/util/List;
